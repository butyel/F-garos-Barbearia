export const SITE = {
  ...
  shortName: "Figaro's",
  url: 'https://figaros-barbearia.vercel.app',
  locale: 'pt_BR',
  description:
...
export const BUSINESS = {
  ...
  description:
    'Barbearia especializada em prótese capilar masculina em Presidente Epitácio (SP). Resultado natural em uma única sessão, sem cirurgia, com manutenção mensal e ambiente climatizado. 4,8 estrelas e mais de 114 avaliações no Google.',
  url: 'https://figaros-barbearia.vercel.app',
  address: {
  ...
  hours: [{ day: 'Segunda a Sábado', hours: '09:00 - 18:00', closed: false }],
